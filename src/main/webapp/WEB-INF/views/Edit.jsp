			...
			<div class="col-md-6 offset-md-3">
				<div class="card mx-auto" style="max-width: 400px">
					...
					<div class="card-body">
						...
						<form action="updateEmp" modelAttribute="emp" method="Post"
							enctype="multipart/form-data">
							<input ="hidden" name="id" />

							<div class="mb-3">
								<label>Enter full Name</label> <input name="Name" value="" />
							</div>
							<div class="mb-3">
								<label>Enter Address</label> <input name="Address" value="" />
							</div>
							<div class="mb-3">
								<label>Enter Email</label> <input name="Email" value="" />
							</div>
							<div class="mb-2">
								<img src="data:image/jpeg;base64,${emp.imageBase64}"
									hight="10px" width="10px" /> <label>Enter Image</label> <input
									name="file" class="form-control" value="" />
							</div>
